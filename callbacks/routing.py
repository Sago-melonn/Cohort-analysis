...
from callbacks.cb_rolling import rolling_layout

_BASE   = "nav-item"
_ACTIVE = "nav-item nav-active"

# active_idx: índice del nav item activo (0-5), None = ninguno (landing)
_ROUTES = {
    "/":        (landing_layout, None),
    ...
    "/ndr":     (ndr_layout,     2),
    "/nnr":     (nnr_layout,     3),
    "/rolling": (rolling_layout, 4),
    "/config":  (config_layout,  5),
}
